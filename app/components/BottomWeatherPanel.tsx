...
export default function BottomWeatherPanel({
  ...
  return (
    <div className="lg:fixed mt-10 lg:mt-0 bottom-0 left-0 px-4 sm:px-8 py-8 w-full flex flex-col sm:flex-row justify-between items-start sm:items-end  text-white z-50">
